...
let click = document.getElementById("clicka");
let hide = document.getElementById("hide");
let closee = document.getElementById("cancel");
...
let right = document.getElementById("menufromside");
let side = document.getElementById("side");
let dgland = document.getElementById("logol");
